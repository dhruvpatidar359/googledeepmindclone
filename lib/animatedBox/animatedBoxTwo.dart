...
class AnimatedBoxTwo extends StatefulWidget {
  const AnimatedBoxTwo({Key? key}) : super(key: key);

  @override
  State<AnimatedBoxTwo> createState() => _AnimatedBoxTwoState();
}

class _AnimatedBoxTwoState extends State<AnimatedBoxTwo>
